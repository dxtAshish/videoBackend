...
export const Register = () => {
  return (
    <div className='form flex flex-col justify-center items-center gap-2 py-2  '>
      <form action="" className='bg-white flex flex-col border-2 p-4 w-[800px] gap-3 rounded-2xl'>
